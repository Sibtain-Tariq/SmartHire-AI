...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200/80 bg-white dark:bg-slate-950 px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-semibold text-slate-900 dark:text-slate-50">SmartHire AI</p>
        ...
        <a href="#top" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 transition hover:text-slate-900 dark:text-slate-50">
          Back to top
          <ArrowRight size={16} />
        </a>
      </div>
