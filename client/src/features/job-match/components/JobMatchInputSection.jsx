...
export default function JobMatchInputSection({ onAnalyze }) {
  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      ...
      // Mock resume object for the result view
      if (onAnalyze) onAnalyze({ title: uploadedResume.name, ats_score: uploadedResume.atsScore }, jobDescription);
    }, 2000);
  };
    ...
    <div className="flex flex-col gap-8">
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-2">
          <div className="mb-2">
            ...
            <p className="text-sm font-medium text-slate-500 mt-1">
              Upload the resume you want to compare with a job description.
            </p>
          </div>
            ...
            <div className="flex flex-col rounded-3xl border border-emerald-200 bg-emerald-50/30 p-8 shadow-sm min-h-[400px]">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-emerald-700/70">Successfully parsed and prepared for analysis.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-5 flex-1">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5"><Activity size={14} /> Mock ATS Score</span>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden min-h-[400px]">
            <textarea
              id="jobDescription"
              placeholder="We are looking for a Software Engineer with experience in React, Python, FastAPI, PostgreSQL, Docker, AWS, REST APIs..."
      ...
      <div className="flex items-center justify-end mt-4">
        <button
          ...
          disabled={!uploadedResume || !jobDescription.trim() || isAnalyzing}
