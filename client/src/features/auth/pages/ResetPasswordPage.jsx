    ...
    <AuthLayout>
      <div className="w-full">
        <div className="mb-8 text-center sm:text-left">
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Create new password</h1>
          <p className="mt-2 text-sm text-slate-600">Your new password must be different from previous used passwords.</p>
        </div>
        ...
        {success ? (
          <div className="mb-6 rounded-2xl border border-emerald-100 bg-emerald-50 p-6 text-center">
            ...
            <h3 className="mt-4 text-sm font-semibold text-slate-900">Password reset complete</h3>
            <p className="mt-2 text-sm text-slate-600">
              Your password has been reset successfully. You can now log in with your new password.
            </p>
            <Link
              to="/login"
              className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl bg-slate-900 py-3.5 text-sm font-semibold text-white outline-none transition hover:bg-slate-800 focus-visible:ring-4 focus-visible:ring-slate-900/10"
            >
              Back to Login
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-6 flex justify-center">
              <Link to="/login" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 transition hover:text-slate-800">
                <ArrowLeft size={16} />
                Back to login
              </Link>
            </div>
